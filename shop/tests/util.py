...
class CartUtilsTestCase(TestCase):
    ...
    def test_having_filled_session_cart_and_empty_database_cart_returns_session_cart(
        self,
    ):
        setattr(self.request, "user", self.user)
        setattr(self.request, "session", {"cart_id": self.cart.pk})
    ...
    def test_having_empty_session_cart_and_filled_database_cart_returns_database_cart(
        self,
    ):
        setattr(self.request, "user", self.user)
        setattr(self.request, "session", {"cart_id": self.cart.pk})
...
class CircularImportTestCase(TestCase):
    ...
    def test_old_import_raises_exception(self):
        self.setup_app("circular_import_old", "circular_import_old.models.MyProduct")
        self.assertRaises(ImproperlyConfigured, cache.load_app, "circular_import_old")
