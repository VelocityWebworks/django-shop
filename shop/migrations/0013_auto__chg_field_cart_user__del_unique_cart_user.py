...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'shop_cart', ['user_id'])


        # Changing field 'Cart.user'
        db.alter_column(u'shop_cart', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Cart.user'
        db.alter_column(u'shop_cart', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Cart', fields ['user']
        db.create_unique(u'shop_cart', ['user_id'])
